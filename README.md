...
|---|---|---|---|
| **Café Fontenebleu** | Site de restaurante (menu, avaliações, eventos). ⚠️ **Incompleto** — a navegação aponta para `home.html`, `info.html` e `dvd.html`, que ainda não foram criados. | [01-Restaurante](HTML/Material%20did%C3%A1tico/Udemy/Desenvolvedor%20web%20completo/PROJETOS/01-Restaurante) | [Abrir](https://marcospontoexe.github.io/HTML5-CSS3/HTML/Material%20did%C3%A1tico/Udemy/Desenvolvedor%20web%20completo/PROJETOS/01-Restaurante/review.html) |
...
| 4 | **[Flexbox](https://www.youtube.com/watch?v=x-4z_u8LcGc)** | Origamid (YouTube) | [CSS/origamid](CSS/material_didatico/origamid) |
